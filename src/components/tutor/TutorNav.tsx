          ...
          <div className="user-menu">
            <details>
              ...
              <div className="user-menu__panel" role="menu">
                ...
                <button className="menu-btn" onClick={() => globalThis.location.assign('/edit-profile')} type="button">✏️ Editar Perfil</button>
                <AddRoleButton currentRole="tutor" asMenuItem />
